...
<script src="xmlpager.js" type="text/javascript"></script>
<script type="text/javascript">
	var TOTAL_SALES = <?php echo $total_count;?>;
</script>
</head>
<body>
<div class="banner">
...
<div id="sales_control">
	<span id="control_first" class="control" onclick="control_first()">&lt;&lt;</span>
	<span id="control_previous" class="control" onclick="control_previous()">&lt;</span>
	<span id="control_last" class="control" onclick="control_last()">&gt;&gt;</span>
	<span id="control_next" class="control" onclick="control_next()">&gt;</span>
</div>
</div>
